...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_question_search_fail(self):
        res = self.client().post('/questions/search', json={'searchTerm': 'xxxx'})
        data = json.loads(res.data)
    ...
    def test_delete_question_fail_2(self):
    ...
    def test_delete_question_fail_3(self):
    ...
    def test_delete_question_fail_4(self):
        res = self.client().delete('/questions/1.0')
        data = json.loads(res.data)
